        ...
        <>
          ...
          >
            ...
            <header className="shrink-0 flex items-center gap-2 px-4 py-3 border-b border-slate-200 bg-white">
              ...
              {headerActions && <div className="flex items-center gap-0.5 shrink-0">{headerActions}</div>}
            </header>
